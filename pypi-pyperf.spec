...
Source0  : https://files.pythonhosted.org/packages/83/28/428de1000f7d1c3754e6b9dd2681a3d2d3395351b1c3118228745605705a/pyperf-2.6.3.tar.gz
...
%prep
%setup -q -n pyperf-2.6.3
cd %{_builddir}/pyperf-2.6.3
pushd ..
cp -a pyperf-2.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709740732
