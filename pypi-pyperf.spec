...
Source0  : https://files.pythonhosted.org/packages/c0/9d/833e27f9c2cee94750af544449a49e4bdc7f98c1673f4413589a0abe98a5/pyperf-2.8.1.tar.gz
...
%prep
%setup -q -n pyperf-2.8.1
cd %{_builddir}/pyperf-2.8.1
pushd ..
cp -a pyperf-2.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731696382
