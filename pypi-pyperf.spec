...
Source0  : https://files.pythonhosted.org/packages/02/2a/758b3c4cc9843bd385bc595b777345fbf4cd00733b7830cdff43e30002c0/pyperf-2.8.0.tar.gz
...
%prep
%setup -q -n pyperf-2.8.0
cd %{_builddir}/pyperf-2.8.0
pushd ..
cp -a pyperf-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727793674
