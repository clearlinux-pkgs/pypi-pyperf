...
Version  : 2.7.0
Release  : 42
URL      : https://files.pythonhosted.org/packages/0d/96/207b47a62f004b75096fad8a7b952b4cd2272cb676880f4d62f9896cc6f5/pyperf-2.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0d/96/207b47a62f004b75096fad8a7b952b4cd2272cb676880f4d62f9896cc6f5/pyperf-2.7.0.tar.gz
...
%prep
%setup -q -n pyperf-2.7.0
cd %{_builddir}/pyperf-2.7.0
pushd ..
cp -a pyperf-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716143413
