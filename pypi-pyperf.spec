...
Source0  : https://files.pythonhosted.org/packages/1b/e6/29b017734c5c705ad6393de05664288c63c98b16a9771a65921ad3f1626a/pyperf-2.6.2.tar.gz
...
%prep
%setup -q -n pyperf-2.6.2
cd %{_builddir}/pyperf-2.6.2
pushd ..
cp -a pyperf-2.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698962807
