...
Source0  : https://files.pythonhosted.org/packages/89/f9/27bd50fb5475147ad04e288a076f29a893c1e94f10866fc3623a84ad75d2/pyperf-2.9.0.tar.gz
...
%prep
%setup -q -n pyperf-2.9.0
cd %{_builddir}/pyperf-2.9.0
pushd ..
cp -a pyperf-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741100436
