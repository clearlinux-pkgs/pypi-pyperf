...
Source0  : https://files.pythonhosted.org/packages/2a/f4/a2e794597b709848b13833e3e0da3a7c6417ed3c82b469b01deb3429df34/pyperf-2.4.0.tar.gz
...
%prep
%setup -q -n pyperf-2.4.0
cd %{_builddir}/pyperf-2.4.0
pushd ..
cp -a pyperf-2.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658344260
...
cp %{_builddir}/pyperf-2.4.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyperf/0c885fb5d06bf65019b498d9cef9641983dd58ad
