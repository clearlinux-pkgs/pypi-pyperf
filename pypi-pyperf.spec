...
Source0  : https://files.pythonhosted.org/packages/37/ed/da8956747c7d6a038fba145c3b3bd8af5ebbfe791814144843ee56476e89/pyperf-2.4.1.tar.gz
...
%prep
%setup -q -n pyperf-2.4.1
cd %{_builddir}/pyperf-2.4.1
pushd ..
cp -a pyperf-2.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659971654
